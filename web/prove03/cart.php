<?php
   ...
   foreach($itemList as $item) {
      ...
      echo("<div class='m-1 p-2 w-50 border rounded'><img src=$imgName class='img-fluid'><p></p><button class='btn btn-danger btn-block' onclick='removeFromCart(\"$item->name\")'>Remove from cart</button></div>");
   }
